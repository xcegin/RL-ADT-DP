NODE_LIST = [
    ...
    'UnaryVariableOperator2','AssignmentStatement','BreakStatement','FunctionCall','FunctionDeclarationStatement',
    'ReturnStatement','VariableDeclarationStatement','IfNode0','IfNode1','LiteralNode','SequenceNode','UnknownNode','ArraySubscriptVariable',
